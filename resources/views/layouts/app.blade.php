                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        <li class="nav-item">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('lipids.list') }}" title="Browse all lipid molecules in the databank"><span class="nav-icon" aria-hidden="true" style="font-size: 1.2rem;">◌</span>Lipids</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ url('/#about') }}" title="About FAIRMD Lipids Databank"><span class="nav-icon" aria-hidden="true">ⓘ</span>About</a></li>
