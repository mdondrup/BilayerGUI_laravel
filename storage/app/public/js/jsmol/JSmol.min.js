(function (a, m) {
    ...
    function t() {
        if (y.addEventListener || "load" === event.type || "complete" === y.readyState) j(), f.ready();
    }
    function s(g, v, a) {
    ...
    function db(g) {
        ...
        if (!p) {
            p = Pa(g, a);
            if ("none" === p || !p)
                (eb = (eb || f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement)), (a = (eb[0].contentWindow || eb[0].contentDocument).document), a.write(), a.close(), (p = Pa(g, a)), eb.detach();
            nc[g] = p;
        }
        return p;
    }
    ...
    function x(g, a, p, b, c) {
        ...
        for (var k = 0; 4 > a; a += 2)
            "margin" === p && (k += f.css(g, p + Qa[a], !0, c)),
                b
                    ? ("content" === p && (k -= f.css(g, "padding" + Qa[a], !0, c)), "margin" !== p && (k -= f.css(g, "border" + Qa[a] + "Width", !0, c)))
                    : ((k += f.css(g, "padding" + Qa[a], !0, c)), "padding" !== p && (k += f.css(g, "border" + Qa[a] + "Width", !0, c)));
        return k;
    }
    function aa(g, a, p) {
        var b = !0,
    ...
    function jb(g, a, p) {
        var b,
            ...
            e = function () {
                if (c) return !1;
                for (var a = Za || ga(), a = Math.max(0, r.startTime + r.duration - a), v = 1 - (a / r.duration || 0), p = 0, b = r.tweens.length; p < b; p++) r.tweens[p].run(v);
    ...
    function ub(g, a, p, b) {
        function c(n) {
            ...
            f.each(g[n] || [], function (g, f) {
                var n = f(a, p, b);
                if ("string" === typeof n && !d && !k[n]) return a.dataTypes.unshift(n), c(n), !1;
                if (d) return !(e = n);
            });
            return e;
        }
    ...
    function na(g, a, p, b) {
        ...
        else if (!p && "object" === f.type(a)) for (c in a) na(g + "[" + c + "]", a[c], p, b);
        else b(g, a);
    }
    function C(g) {
        try {
            ...
            if (null != (c = arguments[d]))
                for (b in c)
                    (g = k[b]),
                        (p = c[b]),
                        k !== p &&
                            (e && p && (f.isPlainObject(p) || (a = f.isArray(p))) ? (a ? ((a = !1), (g = g && f.isArray(g) ? g : [])) : (g = g && f.isPlainObject(g) ? g : {}), (k[b] = f.extend(e, g, p))) : void 0 !== p && (k[b] = p));
        return k;
    };
    f.extend({
        ...
        each: function (g, a, p) {
            ...
            else if (b) for (; f < c && !((b = a.call(g[f], f, g[f])), !1 === b); f++);
        ...
        grep: function (g, a, p) {
            for (var b = [], f = 0, c = g.length, k = !p; f < c; f++) (p = !a(g[f], f)), p !== k && b.push(g[f]);
            return b;
        },
        map: function (g, a, p) {
            var b,
    ...
    var Pb = a,
                ...
                if ((f = gd.exec(g)))
                    if ((k = f[1]))
                        if (9 === d)
                            ...
                            if (a.ownerDocument && (c = a.ownerDocument.getElementById(k)) && sa(a, c) && c.id === k) return p.push(c), p;
                        }
                    else {
            ...
            a: {
                ...
                if (!b && 1 === c.length) {
                    ...
                    for (d = xb.needsContext.test(g) ? 0 : f.length; d--; ) {
                        ...
                        if ((k = G.find[k]))
                            if ((b = k(r.matches[0].replace(Ha, Ia), (Qb.test(f[0].type) && ha(a.parentNode)) || a))) {
                                f.splice(d, 1);
                                g = b.length && vb(f);
                                if (!g) {
                                    Ga.apply(p, b);
        ...
        ua = function (g) {
            return pa(function (a) {
                ...
                return pa(function (p, b) {
                    for (var f, c = g([], p.length, a), k = c.length; k--; ) if (p[(f = c[k])]) p[f] = !(b[f] = p[f]);
                });
            });
        },
        ha = function (g) {
        ...
        ta = function (g, a) {
            ...
            for (n = G.preFilter; k; ) {
                ...
                for (c in G.filter) if ((b = xb[c].exec(k)) && (!n[c] || (b = n[c](b)))) (p = b.shift()), f.push({ value: p, type: c, matches: b }), (k = k.slice(p.length));
                if (!p) break;
            }
    ...
    oa = D.setDocument = function (g) {
        ...
        A = g
            ? function (g, b) {
                  ...
                  return f & 1 || (!H.sortDetached && b.compareDocumentPosition(g) === f)
            ...
            : function (g, b) {
                  ...
                  var k = b.parentNode,
                      d = [g],
                      n = [b];
                  if (!f || !k) return g === a ? -1 : b === a ? 1 : f ? -1 : k ? 1 : ra ? Ua.call(ra, g) - Ua.call(ra, b) : 0;
    ...
    G = D.selectors = {
        ...
        filter: {
                ...
                return 1 === f && 0 === c
                    ...
                    : function (a, b, p) {
                          ...
                          if (j) {
                              ...
                              } else if (p && (v = (a[M] || (a[M] = {}))[g]) && v[0] === ca) r = v[1];
                              else for (; (e = (++h && e && e[b]) || (r = h = 0) || q.pop()); ) if ((n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) && ++r) if ((p && ((e[M] || (e[M] = {}))[g] = [ca, r]), e === a)) break;
                              r -= c;
            ...
            PSEUDO: function (g, a) {
                var b,
                    f = G.pseudos[g] || G.setFilters[g.toLowerCase()] || D.error("unsupported pseudo: " + g);
                return f[M]
                    ? f(a)
                    : 1 < f.length
                    ? ((b = [g, g, "", a]),
        ...
        pseudos: {
            ...
            lang: pa(function (g) {
                ...
                return function (a) {
                    var b;
                    do if ((b = X ? a.lang : a.getAttribute("xml:lang") || a.getAttribute("lang"))) return (b = b.toLowerCase()), b === g || 0 === b.indexOf(g + "-");
    ...
    (f.fn.init = function (g, a) {
        ...
        if ("string" === typeof g) {
            if ((b = "<" === g.charAt(0) && ">" === g.charAt(g.length - 1) && 3 <= g.length ? [null, g, null] : td.exec(g)) && (b[1] || !a)) {
                if (b[1]) {
                    if (((a = a instanceof f ? a[0] : a), f.merge(this, f.parseHTML(b[1], a && a.nodeType ? a.ownerDocument || a : y, !0)), xc.test(b[1]) && f.isPlainObject(a)))
                        for (b in a)
        ...
        if (f.isFunction(g)) return "undefined" !== typeof mb.ready ? mb.ready(g) : g(f);
                            ...
                            .Deferred(function (b) {
                                f.each(a, function (a, p) {
                                    ...
                                    k[p[1]](function () {
                                        ...
                                        else b[p[0] + "With"](this === c ? b.promise() : this, v ? [g] : arguments);
                                    });
                                });
                                g = null;
                            })
    ...
    f(function () {
        ...
        if (b) {
            ...
            if (typeof a.style.zoom !== la && ((a.style.cssText = "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1"), (w.inlineBlockNeedsLayout = 3 === a.offsetWidth))) b.style.zoom = 1;
            b.removeChild(g);
        }
    });
        ...
        data: function (g, a) {
            ...
            if (void 0 === g) {
                if (this.length && ((k = f.data(d)), 1 === d.nodeType && !f._data(d, "parsedAttrs"))) {
                    for (b = n.length; b--; ) (c = n[b].name), 0 === c.indexOf("data-") && ((c = f.camelCase(c.slice(5))), s(d, c, k[c]));
    ...
    var zb = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Va = (f.access = function (a, b, c, k, d, n, e) {
            var r = 0,
                h = a.length,
                q = null == c;
            if ("object" === f.type(c)) for (r in ((d = !0), c)) f.access(a, b, r, c[r], !0, n, e);
            else if (
                void 0 !== k &&
                ((d = !0),
                f.isFunction(k) || (e = !0),
    ...
    for (Ab in { submit: !0, change: !0, focusin: !0 }) if (((Bb = "on" + Ab), !(w[Ab + "Bubbles"] = Bb in a))) Ac.setAttribute(Bb, "t"), (w[Ab + "Bubbles"] = !1 === Ac.attributes[Bb].expando);
    ...
    f.event = {
            ...
            if ((r = f._data(a))) {
                ...
                for (r = b.length; r--; )
                    if (((n = Cc.exec(b[r]) || []), (A = j = n[1]), (z = (n[2] || "").split(".").sort()), A)) {
                        ...
                        n = f.event.special[A] || {};
                        j = f.extend({ type: A, origType: j, data: k, handler: c, guid: c.guid, selector: d, needsContext: d && f.expr.match.needsContext.test(d), namespace: z.join(".") }, h);
        ...
        remove: function (a, b, c, k, d) {
            ...
            if (m && (j = m.events)) {
                b = (b || "").match(xa) || [""];
                for (q = b.length; q--; )
                    if (((r = Cc.exec(b[q]) || []), (z = t = r[1]), (T = (r[2] || "").split(".").sort()), z)) {
                        l = f.event.special[z] || {};
                        z = (k ? l.delegateType : l.bindType) || z;
                        A = j[z] || [];
                        r = r[2] && RegExp("(^|\\.)" + T.join("\\.(?:.*\\.|)") + "(\\.|$)");
                        for (h = n = A.length; n--; )
                            if (((e = A[n]), (d || t === e.origType) && (!c || c.guid === e.guid) && (!r || r.test(e.namespace)) && (!k || k === e.selector || ("**" === k && e.selector))))
                                A.splice(n, 1), e.selector && A.delegateCount--, l.remove && l.remove.call(a, e);
        ...
        trigger: function (g, b, c, k) {
            ...
            if (!(3 === c.nodeType || 8 === c.nodeType) && !Bc.test(l + f.event.triggered))
                if (
                    (0 <= l.indexOf(".") && ((h = l.split(".")), (l = h.shift()), h.sort()),
                    (n = 0 > l.indexOf(":") && "on" + l),
                    ...
                    for (q = 0; (e = j[q++]) && !g.isPropagationStopped(); )
                        if (((g.type = 1 < q ? r : h.bindType || l), (d = (f._data(e, "events") || {})[g.type] && f._data(e, "handle")) && d.apply(e, b), (d = n && e[n]) && d.apply && f.acceptData(e)))
    ...
    f.Event = function (a, b) {
        ...
        a && a.type
            ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && (!1 === a.returnValue || (a.getPreventDefault && a.getPreventDefault()))) ? d : q))
            : (this.type = a);
        b && f.extend(this, b);
                ...
                for (e = 0; null != (d = r[e]); ++e)
                    if (k[e]) {
                        ...
                        if (1 === q.nodeType) {
                            ...
                            else if ("option" === l) q.defaultSelected = q.selected = d.defaultSelected;
            ...
            for (var c, d, n, e, r = 0, h = f.expando, q = f.cache, l = w.deleteExpando, j = f.event.special; null != (c = a[r]); r++)
                if (b || f.acceptData(c))
                    if ((e = (n = c[h]) && q[n])) {
                        ...
                        q[n] && (delete q[n], l ? delete c[h] : typeof c.removeAttribute !== la ? c.removeAttribute(h) : (c[h] = null), k.push(n));
                    }
        },
    });
    f.fn.extend({
        ...
        remove: function (a, b) {
            for (var c, k = a ? f.filter(a, this) : this, d = 0; null != (c = k[d]); d++) !b && 1 === c.nodeType && f.cleanData(E(c)), c.parentNode && (b && f.contains(c.ownerDocument, c) && Q(E(c, "script")), c.parentNode.removeChild(c));
            return this;
        },
        empty: function () {
            ...
            return Va(
                ...
                function (a) {
                    var g = this[0] || {},
                        b = 0,
                        c = this.length;
                    if (void 0 === a) return 1 === g.nodeType ? g.innerHTML.replace(zd, "") : void 0;
        ...
        domManip: function (a, b) {
            ...
            if (h && ((n = f.buildFragment(a, this[0].ownerDocument, !1, this)), (c = n.firstChild), 1 === n.childNodes.length && (n = c), c)) {
                ...
                for (k = d.length; e < h; e++) (c = n), e !== l && ((c = f.clone(c, !0, !0)), k && f.merge(d, E(c, "script"))), b.call(this[e], c, e);
                if (k) {
    ...
    f.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function (a, b) {
        f.fn[a] = function (a) {
            for (var g = 0, c = [], k = f(a), d = k.length - 1; g <= d; g++) (a = g === d ? this : this.clone(!0)), f(k[g])[b](a), z.apply(c, a.get());
    ...
    w.shrinkWrapBlocks = function () {
        ...
        if (null == Cb) {
            ...
            typeof c.style.zoom !== la &&
                ((c.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0;width:1px;padding:1px;zoom:1"),
                (c.innerHTML = "<div></div>"),
        ...
        ? ((Ra = function (a) {
          ...
          (Sa = function (a, b, c) {
              ...
              c &&
                  ...
                  sb.test(d) && Ic.test(b) && ((a = n.width), (b = n.minWidth), (k = n.maxWidth), (n.minWidth = n.maxWidth = n.width = d), (d = c.width), (n.width = a), (n.minWidth = b), (n.maxWidth = k)));
              return void 0 === d ? d : d + "";
          }))
    ...
    var dc = function () {
            ...
            c &&
                ...
                (Eb = !1),
                (Fb = !0),
                a.getComputedStyle && ((Eb = "1%" !== (a.getComputedStyle(b, null) || {}).top), (Db = "4px" === (a.getComputedStyle(b, null) || { width: "4px" }).width)),
                c.removeChild(g),
                (b = c = null));
        },
        pb,
        ...
        style: function (a, b, c, k) {
            if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
                ...
                if (void 0 !== c) {
                    ...
                    if (!(null == c || c !== c))
                        if (("number" === n && !f.cssNumber[r] && (c += "px"), !w.clearCloneStyle && "" === c && 0 === b.indexOf("background") && (h[b] = "inherit"), !e || !("set" in e) || void 0 !== (c = e.set(a, c, k))))
                            try {
                                (h[b] = ""), (h[b] = c);
                            } catch (q) {}
                } else return e && "get" in e && void 0 !== (d = e.get(a, !1, k)) ? d : h[b];
            }
        },
    ...
    w.opacity ||
        (f.cssHooks.opacity = {
            ...
            set: function (a, b) {
                ...
                c.zoom = 1;
                if ((1 <= b || "" === b) && "" === f.trim(n.replace(ec, "")) && c.removeAttribute) if ((c.removeAttribute("filter"), "" === b || (k && !k.filter))) return;
            ...
            function (a, b, c) {
                ...
                if (1 === a.nodeType && ("height" in b || "width" in b))
                    (c.overflow = [l.overflow, l.overflowX, l.overflowY]),
                        ...
                        (h = db(a.nodeName)),
                        "none" === d && (d = h),
                        "inline" === d && "none" === f.css(a, "float") && (!w.inlineBlockNeedsLayout || "inline" === h ? (l.display = "inline-block") : (l.zoom = 1));
                c.overflow &&
                    ((l.overflow = "hidden"),
                    w.shrinkWrapBlocks() ||
                        q.always(function () {
                ...
                if (!f.isEmptyObject(j))
                    ...
                    j))
                        (b = wa(A ? z[k] : 0, k, q)), k in z || ((z[k] = b.start), A && ((b.end = b.start), (b.start = "width" === k || "height" === k ? 1 : 0)));
            },
        ],
        ib = {
            "*": [
    ...
    f.Animation = f.extend(jb, {
        tweener: function (a, b) {
            ...
            for (var c, k = 0, d = a.length; k < d; k++) (c = a[k]), (ib[c] = ib[c] || []), ib[c].unshift(b);
        },
    ...
    f.speed = function (a, b, c) {
        var k = a && "object" === typeof a ? f.extend({}, a) : { complete: c || (!c && b) || (f.isFunction(a) && a), duration: a, easing: (c && b) || (b && !f.isFunction(b) && b) };
    ...
    f.each({ slideDown: O("show"), slideUp: O("hide"), slideToggle: O("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (a, b) {
    ...
    f.fn.extend({
        ...
        toggleClass: function (a, b) {
            ...
            return "boolean" === typeof b && "string" === c
                ...
                : this.each(function () {
                      if ("string" === c) for (var b, k = 0, d = f(this), n = a.match(xa) || []; (b = n[k++]); ) d.hasClass(b) ? d.removeClass(b) : d.addClass(b);
        ...
        ajax: function (a, b) {
            function c(a, b, g, k) {
                ...
                if (2 !== ea) {
                                    ...
                                    if (!Y)
                                        for (w in v)
                                            if (((p = w.split(" ")), p[1] === B && (Y = v[u + " " + p[0]] || v["* " + p[0]]))) {
                                                !0 === Y ? (Y = v[w]) : !0 !== v[w] && ((B = p[0]), E.unshift(p[1]));
                                                break;
                                            }
                                    if (!0 !== Y)
                                        if (Y && g["throws"]) N = Y(N);
                    ...
                    if (k)
                        j.ifModified && ((I = s.getResponseHeader("Last-Modified")) && (f.lastModified[n] = I), (I = s.getResponseHeader("etag")) && (f.etag[n] = I)),
                            204 === a || "HEAD" === j.type ? (I = "nocontent") : 304 === a ? (I = "notmodified") : ((I = p.state), (d = p.data), (l = p.error), (k = !l));
    ...
    f.expr.filters.hidden = function (a) {
        return (0 >= a.offsetWidth && 0 >= a.offsetHeight) || (!w.reliableHiddenOffsets() && "none" === ((a.style && a.style.display) || f.css(a, "display")));
    };
    ...
    f.ajaxSettings.xhr =
        void 0 !== a.ActiveXObject
            ? function () {
                  var b;
                  if (!(b = !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && ba()))
                      a: {
                          try {
    ...
    f.ajaxSettings.xhr =
        void 0 === a.ActiveXObject
            ? C
            : function () {
                  return ((this.url == y.location || 0 == this.url.indexOf("http") || !this.isLocal) && /^(get|post|head|put|delete|options)$/i.test(this.type) && C()) || C(1);
              };
    var Wd = 0,
        Kb = {},
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, k) {
        ...
        if (r || "jsonp" === b.dataTypes[0])
            return (
                (d = b.jsonpCallback = f.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback),
    ...
    f.fn.extend({
        offset: function (a) {
            ...
            if (d) {
                ...
                c = V(d);
                return { top: k.top + (c.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: k.left + (c.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) };
            }
        },
        position: function () {
            if (this[0]) {
...
(function (a) {
    ...
    a.support.iecors
        ? a.ajaxTransport(function (a) {
              return {
                  send: function (h, e) {
                      ...
                      j.onload = function () {
                          e(200, "OK", { text: j.responseText }, { "Content-Type": j.contentType });
                      };
        ...
        : (a.ajaxSetup({ accepts: { binary: "text/plain; charset=x-user-defined" }, responseFields: { binary: "response" } }),
...
Jmol._version ||
    (Jmol = (function (a) {
        var m = function (a) {
                return { rear: a++, header: a++, main: a++, image: a++, front: a++, fileOpener: a++, coverImage: a++, dialog: a++, menu: a + 9e4, console: a + 91e3, consoleImage: a + 91001, monitorZIndex: a + 99999 };
            },
            m = {
                _version: "$Date: 2020-12-12 18:52:48 -0600 (Sat, 12 Dec 2020) $",
                _alertNoBinary: !0,
...
(function (a, m) {
    ...
    a._fixProtocol = function (b) {
        ...
        return 0 == b.indexOf("http://www.rcsb.org/pdb/files/") && 0 > b.indexOf("/ligand/")
            ...
            : 0 == b.indexOf("http://") && ("https://" == a._httpProto || 0 < b.indexOf(".gov/") || 0 == b.indexOf("http://www.materialsproject"))
            ? "https" + b.substring(4)
            : b;
    };
    ...
    a._getGrabberOptions = function (b) {
        ...
        for (var c = c + '<select id="ID_select">', e = 0; e < a._grabberOptions.length; e++) var j = a._grabberOptions[e], c = c + ('<option value="' + j[0] + '" ' + (0 == e ? "selected" : "") + ">" + j[1] + "</option>");
                ...
                ? ((e = b.toLowerCase()),
                  isNaN(parseInt(b.substring(1)))
                      ? 0 == e.indexOf(":smiles:")
                          ...
                          : 0 == e.indexOf(":cid:")
                          ? (b = "cid/" + b.substring(5))
                          : (0 == e.indexOf(":name:") ? (b = b.substring(5)) : 0 == e.indexOf(":cas:") && (b = b.substring(4)), (b = "name/" + encodeURIComponent(b.substring(d))))
                      : (b = "cid/" + b.substring(1)))
                : (b = encodeURIComponent(b.substring(d))),
            0 <= b.indexOf(".mmtf") ? (b = "https://mmtf.rcsb.org/v1.0/full/" + b.replace(/\.mmtf/, "")) : 0 <= j.indexOf("FILENCI") ? ((b = b.replace(/\%2F/g, "/")), (b = j.replace(/\%FILENCI/, b))) : (b = j.replace(/\%FILE/, b)));
        return b;
    };
    ...
    a._searchMol = function (b, c, d, e) {
        ...
        if (c && !(0 > h.indexOf("?") && h == b._thisJmolModel)) {
            b._thisJmolModel = h;
            var l;
            e && null != b._viewSet && null != (l = a.View.__findView(b._viewSet, { chemID: h }))
                ? a.View.__setView(l, b, !1)
                : ("$" == j || ":" == j ? (b._jmolFileType = "MOL") : "=" == j && (b._jmolFileType = "PDB"), b._searchDatabase(c, j, d));
        }
    };
    ...
    a._canSyncBinary = function (b) {
        ...
        try {
            ...
            return (
                System.out.println("JSmolCore.js: synchronous binary file transfer is requested but not available"),
    ...
    a._getFileData = function (b, c, d) {
        ...
        var s = !l && a.$supportsIECrossDomainScripting(),
            u = null;
        if (t || j || (!l && !m) || (!c && s)) u = a._getRawDataFromServer("_", b, c, c, j, !0);
        else {
    ...
    a.loadFileAsynchronously = function (b, c, d, e) {
        ...
        a.$appEvent(c, "localReader_loadfile", "click", function () {
            ...
            j.onloadend = function (j) {
                j.target.readyState == FileReader.DONE && (a._hideLocalFileReader(c, 0), a._setData(b, d.name, d.name, j.target.result, e, c));
            };
            try {
    ...
    a.doAjax = function (b, c, d) {
        ...
        if (d) {
            ...
            b = { async: !1, url: b, type: "POST", data: "string" == typeof data ? d : ";base64," + (JU || J.util).Base64.getBase64(d).toString(), processData: !1 };
    ...
    a._saveFile = function (b, c, d, e) {
        ...
        a._useDataURI || !j
            ? ((e = document.createElement("a")), (e.href = "data:" + d + ";base64," + c), (e.type = d || "text/plain;charset=utf-8"), (e.download = b), (e.target = "_blank"), m("body").append(e), e.click(), e.remove())
            : (a._formdiv ||
                  (a.$after(
                      "body",
    ...
    a._jsGetXY = function (b, c) {
        ...
        j.targetTouches && j.targetTouches[0]
            ? ((e = j.targetTouches[0].pageX - d.left), (d = j.targetTouches[0].pageY - d.top))
            : j.changedTouches
            ? ((e = j.changedTouches[0].pageX - d.left), (d = j.changedTouches[0].pageY - d.top))
    ...
    s.setDialog = function (b) {
        ...
        d[0]
            ...
            : (a.$after("body", "<div id='" + c + "' style='position:absolute;left:0px;top:0px;'>" + b.html + "</div>"),
              (e = new s.JSDialog()),
              (d = a._$(c)),
              (b.container = d),
    ...
    s.click = function (b, c) {
        ...
        if (d) {
            ...
            else if (null != d.text && ((d.text = b.value), c && 13 != (c.charCode || c.keyCode))) return;
        }
        ...
        if (a._tracker) {
            try {
                var c =
                    ...
                    (a._tracker + "&applet=" + b._jmolType + "&version=" + a._version + "&appver=" + a.___JmolVersion + "&url=" + encodeURIComponent(document.location.href)) +
                    '"></iframe>';
                a.$after("body", c);
            } catch (d) {}
            delete a._tracker;
    ...
    a.getProfile = function (a) {
        if (self.Clazz && self.JSON) return u || Clazz._startProfiling((u = 0 == arguments.length || a)), Clazz.getProfile();
    };
    ...
    a.Cache.setDragDrop = function (b) {
        ...
        a.$appEvent(b, "appletdiv", "drop", function (c) {
            ...
            if (null == e)
                try {
                    (e = "" + d.dataTransfer.getData("text")), (0 == e.indexOf("file:/") || 0 == e.indexOf("http:/") || 0 == e.indexOf("https:/")) && b._scriptLoad(e);
                } catch (j) {}
            else
                (d = new FileReader()),
                    (d.onloadend = function (d) {
                        if (d.target.readyState == FileReader.DONE) {
                            ...
                            (d = a._jsGetXY(b._canvas, c)) && (!b._appletPanel.setStatusDragDropped || b._appletPanel.setStatusDragDropped(0, d[0], d[1], j)) && b._appletPanel.openFileAsyncSpecial(j, 1);
                        }
                    }),
...
(function (a) {
    ...
    a._jsSetPrototype = function (b) {
        ...
        b._createCanvas2d = function () {
            ...
            if (this._isLayered) {
                ...
                b.append(l);
                a._$(l.id).css({ zIndex: a._getZ(this, "image"), position: "absolute", left: "0px", top: "0px", width: (this._isSwing ? e : 0) + "px", height: (this._isSwing ? j : 0) + "px", overflow: "hidden" });
                this._isSwing
                    ? ((b = document.createElement("div")),
                      (b.id = this._id + "_swingdiv"),
                      a._$(this._id + "_appletinfotablediv").append(b),
                      a._$(b.id).css({ zIndex: a._getZ(this, "rear"), position: "absolute", left: "0px", top: "0px", width: e + "px", height: j + "px", overflow: "hidden" }),
        ...
        b._getLayer = function (b, c, e, j, h) {
            ...
            c.append(l);
            l.applet = this;
            a._$(l.id).css({ background: h ? "rgb(0,0,0,1)" : "rgb(0,0,0,0.001)", "z-index": a._getZ(this, b), position: "absolute", left: "0px", top: "0px", overflow: "hidden" });
            return l;
        };
        b._setupJS = function () {
            window["j2s.lib"] = { base: this._j2sPath + "/", alias: ".", console: this._console, monitorZIndex: a._getZ(this, "monitorZIndex") };
    ...
    a.repaint = function (b, e) {
        if (b && b._appletPanel) {
            ...
            if (b._is2D && (b._canvas.width != h || b._canvas.height != j)) b._newCanvas(!0), b._appletPanel.setDisplay(b._canvas);
    ...
    a.getHiddenCanvas = function (b, e, j, h, l, t) {
        ...
        b = a._canvasCache[e];
        if (t) return b;
        if (l || !b || b.width != j || b.height != h) (b = document.createElement("canvas")), (b.width = b.style.width = j), (b.height = b.style.height = h), (b.id = e), (a._canvasCache[e] = b);
        return b;
    };
...
(function (a, m) {
            ...
            if (this._jarFile) {
                ...
                0 <= c.indexOf("/")
                    ? (alert(
                      ...
                      "yes" == prompt("Do you want to use applet " + c + "? ", "yes or no") ? ((e = c.substring(0, c.lastIndexOf("/"))), (h = c.substring(c.lastIndexOf("/") + 1))) : (b = !0))
                    : (h = c);
    ...
    l._getCanvas = function (e, j, h, m) {
        ...
        return m && a.featureDetection.supportsWebGL()
            ? ((a._Canvas3D.prototype = a.GLmol.extendApplet(a._jsSetPrototype(new l(e, j, !0)))), new a._Canvas3D(e, j, "Jmol", h))
            : !m
            ? ((a._Canvas2D.prototype = a._jsSetPrototype(new l(e, j, !0))), new a._Canvas2D(e, j, "Jmol", h))
            : null;
    };
    l._noJavaMsg =
    ...
    l._createApplet = function (e, j, h) {
        ...
        c =
            a.featureDetection.useIEObject || a.featureDetection.useHtml4Object
                ? "<object " +
                  b +
                  (a.featureDetection.useIEObject ? " classid='clsid:8AD9C840-044E-11D1-B3E9-00805F499D93' codebase='http://java.sun.com/update/1.6.0/jinstall-6u22-windows-i586.cab'>" : " type='application/x-java-applet'>") +
                  c +
    ...
    h._resizeApplet = function (e) {
        function h(e, j) {
            ...
            return 0 == b.length
                ...
                ? 100 * e + "%"
                : (isNaN((e = Math.floor(e))) ? a._allowedJmolSize[2] : e < a._allowedJmolSize[0] ? a._allowedJmolSize[0] : e > a._allowedJmolSize[1] ? a._allowedJmolSize[1] : e) + (j ? j : "");
        }
        var l;
    ...
    h.__loadModel = function (e, h, l) {
        null != e &&
            (null != this._viewSet && (h || (h = ""), (h += ";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};")),
    ...
    h._updateView = function () {
        null != this._viewSet &&
            ...
            a.View.updateView(this, { chemID: chemID, data: "" + this._getPropertyAsJavaObject("evaluate", "extractModel", "{visible}") }));
    };
...
(function (a) {
        ...
        switch (l) {
            case 13:
                return (
                    ...
                    j._cmds || ((j._cmds = []), (j._cmddir = 0), (j._cmdpt = -1), (j._cmdadd = 0)),
                    h && 0 == j._cmdadd ? (++j._cmdpt, j._cmds.splice(j._cmdpt, 0, h), (j._cmdadd = 0), (j._cmddir = 0)) : (j._cmdadd = 0),
                    (j.value = ""),
                    !1
                );
            case 27:
    ...
    m._cbSetCheckboxGroup = function (a, h, e) {
        ...
        for (a = j; a < h.length; a++)
            (j = h[a]), "number" == typeof j && (j = "jmolCheckbox" + j), (e = document.getElementById(j)) || alert("jmolSetCheckboxGroup: group checkbox not found: " + j), (t.chkGroup[j] = e), (m._checkboxItems[j] = t);
    };
        ...
        if (null != s && "object" == s && h.length) {
            ...
            for (j = 0; j < u; ++j) {
                var b = h[j],
                    ...
                    c = null,
                    d = (t = null);
                "object" == s && null != b ? ((c = b[0]), (t = b[1]), (d = b[2])) : (c = t = b);
        ...
        if ("object" != u || null == u || !h.length) alert("invalid arrayOfRadioButtons");
            ...
            for (var c = "<span id='" + (t ? t : j) + "'>", d = 0; d < b; ++d) {
                ...
                var q = h[d],
                    u = typeof q,
                    I = null,
                    c = "object" == u ? c + (I = m._radio(l, q[0], q[1], q[2], e, j, 3 < q.length ? q[3] : (t ? t : j) + "_" + d, 4 < q.length ? q[4] : 0, s)) : c + (I = m._radio(l, q, null, null, e, j, (t ? t : j) + "_" + d, s));
                if (null == I) return "";
            }
            c += "</span>";
            a._debugAlert && alert(c);
...
LoadClazz = function () {
    ...
    window["j2s.clazzloaded"] ||
        ...
        (function (a, m) {
            ...
            var u = function (a, b) {
                for (var c in b) if ("b$" != c && "prototype" != c && "superClazz" != c && "__CLASS_NAME__" != c && "implementz" != c && ("function" != typeof b[c] || !t(b, c))) a[c] = a.prototype[c] = b[c];
            };
            ...
            a.superCall = function (b, c, d, e) {
                ...
                if (h) return 0 == j && "construct" == d && (c = l.stacks) && !c[0].superClazz && c[0].con$truct && c[0].con$truct.apply(b, []), h.apply(b, e || []);
                    ...
                    (c = a.construct)
                        ? a.con$truct
                            ? a.getClass().superClazz
                                ? (c.claxxOwner && c.claxxOwner === a.getClass()) || (c.stacks && c.stacks[c.stacks.length - 1] == a.getClass())
                                    ? c.apply(a, b)
                                    : (c.claxxOwner && !c.claxxOwner.superClazz && c.claxxOwner.con$truct
                                          ? c.claxxOwner.con$truct.apply(a, [])
                                          : c.stacks && 1 == c.stacks.length && !c.stacks[0].superClazz && c.stacks[0].con$truct.apply(a, []),
                                      c.apply(a, b),
                                      a.con$truct.apply(a, []))
            ...
            !0 == (a.haveInt32 = !!(self.Int32Array && self.Int32Array != Array))
                ? Int32Array.prototype.sort || (Int32Array.prototype.sort = Array.prototype.sort)
            ...
            !0 == (a.haveFloat64 = !!(self.Float64Array && self.Float64Array != Array))
                ? Float64Array.prototype.sort || (Float64Array.prototype.sort = Array.prototype.sort)
            ...
            !0 == (a.haveInt8 = !!self.Int8Array)
                ? (Int8Array.prototype.sort || (Int8Array.prototype.sort = Array.prototype.sort),
            ...
            (function (a, b) {
                    ...
                    if (a instanceof Array)
                        if ((C(a), e))
                            h < a.length
                                ...
                                : e();
                        else for (j = 0; j < a.length; j++) b.loadPackageClasspath(a[j], c, d, null);
                    else {
                        switch (a) {
                            case "java.*":
                                a = "java";
                ...
                var V = function (c, d, f, j, l) {
                        ...
                        if (M && !sa) {
                            ...
                            l && l();
                        } else (c = { dataType: "script", async: !0, type: "GET", url: d, success: ua(d, !1, l), error: ua(d, !0, l) }), h++, j ? setTimeout(c.success, 0) : m.$ajax(c);
                    },
                    ua = function (c, d, e) {
                        a.getStackTrace();
                        return function () {
                    ...
                    ta = function (c, f) {
                        ...
                        if (l) {
                            ...
                            if (l instanceof Array) for (q = 0; q < l.length; q++) l[q].status < x.STATUS_CONTENT_LOADED && ((l[q].status = x.STATUS_CONTENT_LOADED), updateNode(l[q]));
                            ...
                            if (b.keepOnLoading) {
                                q = !0;
                                if ((m = Ka(x.STATUS_KNOWN))) for (S(m); h < j && (m = Ka(x.STATUS_KNOWN)); ) S(m);
                                ...
                                else if ((m = G(x.STATUS_KNOWN))) for (S(m); h < j && (m = G(x.STATUS_KNOWN)); ) S(m);
                                else q = !1;
                                if (!(q || 0 < h)) {
                                    l = [Ka, G];
                                    r = null;
                        ...
                        if (c) {
                            ...
                            if ((0 == a.optionals.length && 0 == a.musts.length) || (a.status > x.STATUS_KNOWN && !a.declaration) || (Ta(a.musts, x.STATUS_LOAD_COMPLETE) && Ta(a.optionals, x.STATUS_LOAD_COMPLETE))) {
                                ...
                                if (a.declaration && a.declaration.clazzList) {
                                    j = 0;
                                    k = a.declaration.clazzList;
                                    for (l = k.length; j < l; j++) if ((m = H(k[j])) && m.status != c && m !== a) if (((m.declaration = null), !wa(m, c))) return !1;
                                }
                            }
            ...
            aa.showStatus = function (a, b) {
                if (!O) {
                    ...
                    c.id = "_Loader-status";
                    c.style.cssText =
                        "position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:" + (window["j2s.lib"].monitorZIndex || 1e4) + ";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";
                    c.onmouseover = ub;
                    O = c;
